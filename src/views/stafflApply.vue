<template>
    <div class=".BodyDiv">
        <div align="center">
            <table border="1px" bordercolor="#E4E7ED" width="900xp" cellpadding="5" cellspacing="0" :model="staff">
                <tr>
                    <td colspan="4">
                ...
                <tr>
                    ...
                    <td width="225">
                        <el-date-picker type="date" placeholder="选择日期" v-model="staff.staff_time" style="width: 100%">
                        </el-date-picker>
                    </td>
                </tr>
                <tr>
            ...
            <table border="1px" :model="staff" bordercolor="#E4E7ED" width="900xp" cellpadding="5" cellspacing="0">
                <tr>
                    <td align="left" colspan="4" style="background-color: #daecf7">
                        招聘要求信息
                    </td>
            ...
            <table border="1px" :model="staff" bordercolor="#E4E7ED" width="900xp" cellpadding="5" cellspacing="0">
                ...
                <tr>
                    ...
                    <td width="225">
                        <el-date-picker v-model="staff.staff_probation" type="date" placeholder="选择日期">
                        </el-date-picker>
                    </td>
                </tr>
                <tr>
            ...
            <table style="
                ...
                " cellspacing="0" cellpadding="0" width="900px" border="1" :model="staff">
                <tbody>
                    <tr>
                        <td width="900px">
                            <textarea ID="XCommentsTextBox2" CssClass="printer" runat="server" BorderColor="#DCDCDC"
                                BorderWidth="1" Width="900px" Rows="3" TextMode="MultiLine"
                                v-model="staff.staff_remarks"></textarea>
                        </td>
                    </tr>
                </tbody>
            </table>
