    ...
    <div align="center">
      ...
      >
        ...
        <tr>
          ...
          <td width="225">
            <input type="text" v-model="employed.employed_Date" />
          </td>
        </tr>
        <tr>
          <td align="left" width="225" style="background-color: #f6f5f4">
          ...
          <td width="225">
            <input type="text" v-model="employed.employedEntry_JobName" />
          </td>
          <td align="left" width="225" style="background-color: #f6f5f4">
            岗位说明
          </td>
          <td width="225">
            <input type="text" v-model="employed.employed_Instruction" />
          </td>
        </tr>
        <tr>
          <td align="left" width="225" style="background-color: #f6f5f4">
          ...
          <td width="225">
            <input type="text" v-model="employed.employed_Categary" />
          </td>
        </tr>
      </table>
      <table
      ...
      >
        ...
        <tr>
          ...
          <td width="225">
            <input type="text" v-model="employed.name" />
          </td>
          <td align="left" width="225" style="background-color: #f6f5f4">
            性别
          </td>
          <td width="225">
            <input type="text" v-model="employed.employed_Sex" />
          </td>
        </tr>
        <tr>
          <td align="left" width="225" style="background-color: #f6f5f4">
          ...
          <td width="225">
            <input type="text" v-model="employed.employed_Year" />
          </td>
          <td align="left" width="225" style="background-color: #f6f5f4">
            文化程度
          </td>
          <td width="225">
            <input type="text" v-model="employed.employed_Culture" />
          </td>
        </tr>
        <tr>
          <td align="left" width="225" style="background-color: #f6f5f4">
          ...
          <td width="225">
            <input type="text" v-model="employed.employed_Health" />
          </td>
          <td align="left" width="225" style="background-color: #f6f5f4">
            电话
          </td>
          <td width="225">
            <input type="text" v-model="employed.employed_Phone" />
          </td>
        </tr>
        <tr>
          <td align="left" width="225" style="background-color: #f6f5f4">
          ...
          <td width="225">
            <input type="text" v-model="employed.employed_Address" />
          </td>
        ...
        <tr>
          ...
          <td width="225">
            <input type="text" v-model="employed.employed_Specialty" />
          </td>
          <td align="left" width="225" style="background-color: #f6f5f4"></td>
          <td width="225">
            <input type="text" />
        ...
        <tr>
          ...
          <td width="225">
            <input type="text" v-model="employed.employed_Relative" />
          </td>
          <td align="left" width="225" style="background-color: #f6f5f4">
            拟定工资及待遇
          </td>
          <td width="225">
            <input type="text" v-model="employed.employed_Treatment" />
          </td>
        </tr>
        <tr>
          <td align="left" width="225" style="background-color: #f6f5f4">
          ...
          <td width="225">
            <input type="text" v-model="employed.employed_Timelimit" />
          </td>
          <td align="left" width="225" style="background-color: #f6f5f4">
            试用期
          </td>
          <td width="225">
            <input type="text" v-model="employed.employed_Thetrial" />
          </td>
        </tr>
      </table>
