        ...
        >
            ...
            <tr>
                ...
                <td width="225">
                    <select
                        style="
                            ...
                            outline: none;
                        "
                        v-model="employedform.employed_Department"
                        placeholder="请输入"
                    >
                        <option
                            @click="GetRole()"
                ...
                <td width="225">
                    <input
                        type="date"
                        v-model="employedform.employed_Date"
                        placeholder="选择日期"
                        style="
                ...
                <td width="225">
                    <select
                        style="
                            ...
                            outline: none;
                        "
                        v-model="employedform.employedEntry_JobName"
                        placeholder="请输入"
                    >
                        <option
                            v-for="item in lib"
        ...
        >
            ...
            <tr>
                ...
                <td width="225">
                    <input
                        type="date"
                        v-model="employedform.employed_Year"
                        placeholder="选择日期"
                        style="
                            outline-color: invert;
                            outline-style: none;
                ...
                <td width="225">
                    <input
                        type="text"
                        v-model="employedform.employed_Culture"
                        style="
                            outline-color: invert;
                            outline-style: none;
                            outline-width: 0px;
            ...
            <tr>
                ...
                <td width="225">
                    <input
                        type="text"
                        v-model="employedform.employed_Health"
                        style="
                            outline-color: invert;
                            outline-style: none;
                            outline-width: 0px;
                ...
                <td width="225">
                    <input
                        type="text"
                        v-model="employedform.employed_Phone"
                        style="
                            outline-color: invert;
                            outline-style: none;
                            outline-width: 0px;
            ...
            <tr>
                ...
                <td width="225">
                    <input
                        type="text"
                        v-model="employedform.employed_Address"
                        style="
                            outline-color: invert;
                            outline-style: none;
                            outline-width: 0px;
            ...
            <tr>
                ...
                <td width="225">
                    <input
                        type="text"
                        v-model="employedform.employed_Specialty"
                        style="
                            outline-color: invert;
                            outline-style: none;
                            outline-width: 0px;
            ...
            <tr>
                ...
                <td width="225">
                    <input
                        type="text"
                        v-model="employedform.employed_Treatment"
                        style="
                            outline-color: invert;
                            outline-style: none;
                            outline-width: 0px;
            ...
            <tr>
                ...
                <td width="225">
                    <input
                        type="text"
                        v-model="employedform.employed_Timelimit"
                        style="
                            outline-color: invert;
                            outline-style: none;
                            outline-width: 0px;
                ...
                <td width="225">
                    <input
                        type="text"
                        v-model="employedform.employed_Thetrial"
                        style="
                            outline-color: invert;
                            outline-style: none;
                            outline-width: 0px;
        ...
        >
            ...
            <tr>
                ...
                <td width="225">
                    <input
                        type="text"
                        v-model="folk.relative_Position"
                        style="
                            outline-color: invert;
                            outline-style: none;
                            outline-width: 0px;
            ...
            <tr>
                <td
                    align="left"
                    colspan="4"
                    style="width: 100%; background-color: #daecf7"
                >
                    备注
                </td>
            </tr>
