            ...
            >
                ...
                <tr>
                    ...
                    <td width="225">
                        <select
                            v-model="
                                ReservationMeetingRoom.Reservation_MeetingRoom
                            "
                            placeholder="请选择"
                            style="
                                width: 100%;
                ...
                <tr>
                    ...
                    <td width="225">
                        <input
                            type="text"
                            v-model="
                                ReservationMeetingRoom.Reservation_UseDepartment
                            "
                            style="
                                outline-color: invert;
                                outline-style: none;
                ...
                <tr>
                    ...
                    <td width="225">
                        <input
                            type="date"
                            v-model="
                                ReservationMeetingRoom.Reservation_BeginTime
                            "
                            style="
                                outline-color: invert;
                                outline-style: none;
                    ...
                    <td width="225">
                        <input
                            type="date"
                            v-model="
                                ReservationMeetingRoom.Reservation_OverTime
                            "
                            style="
                                outline-color: invert;
                                outline-style: none;
