    ...
    >
      ...
      <tr>
        ...
        <td width="225" colspan="3">
          <textarea cols="100" v-model="leaveform.leave_Reason"></textarea>
        </td>
      </tr>
      <tr>
        <td align="left" width="225" style="background-color: #f6f5f4">附件</td>
        <td width="225" colspan="3">
          <el-upload
            style="float: left"
            action="https://jsonplaceholder.typicode.com/posts/"
          >
            <el-button type="success" size="mini">+ 添加附件</el-button>
          </el-upload>
        </td>
      </tr>
      <tr>
        <td align="left" colspan="4" style="background-color: #daecf7">备注</td>
      </tr>
      <tr>
        <td width="225" colspan="4">
          <textarea cols="120" v-model="leaveform.leave_Remark"></textarea>
        </td>
      </tr>
      <tr>
        <td colspan="4">
          <div style="height: 21px">
            <button type="info" style="float: left" @click="AddLeaveApply">
              提交
            </button>
          </div>
        </td>
